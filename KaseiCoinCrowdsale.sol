...
// A contract to deploy the token and the crowdsale contracts
contract KaseiCoinCrowdsaleDeployer {
    ...
    constructor(
        ...
        KaseiCoinCrowdsale token_crowdsale= new KaseiCoinCrowdsale(1, wallet, token, goal, now, now + 10 minutes);
